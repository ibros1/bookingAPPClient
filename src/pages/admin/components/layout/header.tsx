...
const AdminHeader = () => {
  ...
  return (
    <>
      <header className="w-full flex items-center justify-between py-2 px-6 bg-white dark:bg-[#0a1126]  border-gray-200 dark:border-gray-700 border-b z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* User Role */}
          <div className="px-3 py-1 border rounded-md text-sm font-medium bg-gray-100 dark:bg-[#1b2540] border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-200">
            {user.role}
          </div>
          {/* Profile Dropdown */}
